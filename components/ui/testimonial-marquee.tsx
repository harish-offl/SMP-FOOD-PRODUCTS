...
const reviews = [
  ...
  },
  {
    name: "Lirael Nassun",
    username: "@lnassun",
    body: "This is easily one of the most reliable SaaS tools we have adopted. The UI is intuitive, integrations are seamless, and it saves us countless hours every week.",
  ...
  },
  {
    name: "Jenny",
    username: "@jenny",
    body: "We evaluated multiple solutions, but this stood out immediately. It is fast, scalable, and thoughtfully designed for growing teams that need stability without added complexity.",
