...
const csvPath = path.join('C:\\Users\\Annamalai\\Downloads', 'smp_food_products_english (2).csv');
const outputPath = path.join('C:\\Users\\Annamalai\\Desktop\\PROJECT FOLDER\\SMP-FOOD-PRODUCTS', 'data', 'products.ts');
...
const categoriesArray = [
  { id: 'c1', name: 'All Products', slug: 'all', description: 'Complete range of SMP Food Products.', image: '/images/category-placeholder.svg', productCount: products.length },
];
